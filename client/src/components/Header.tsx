  ...
  if (pageSize !== undefined && pageSize < 768) {
    ...
    return (
      <div className="flex flex-row justify-between items-center px-16 py-8">
        ...
        <button className="group/button relative inline-flex items-center justify-center overflow-hidden rounded-md bg-black backdrop-blur-lg px-6 py-2 text-base text-white transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-xl hover:shadow-gray-600/50 border border-white/20">
