  ...
  return (
    <div className='background select-none space-y-20 min-[600px]:space-y-28 lg:space-y-36 xl:space-y-48'>
      ...
      <div className='flex flex-col items-center justify-center gap-8 min-[600px]:gap-16 pb-20 md:pb-32'>
        <div>
          <GradualSpacing text="Go Tawk 1+1 = 2ah" className='font-lexend text-4xl min-[600px]:text-5xl md:text-6xl lg:text-7xl xl:text-8xl'/>
          <GradualSpacing text="on Web3" className='font-lexend text-4xl min-[600px]:text-5xl md:text-6xl lg:text-7xl xl:text-8xl' duration={0.9} delayMultiple={0.1}/>
        </div>
        <div className='flex flex-col items-center'>
          <h2 className='font-lexend text-gray-500 text-lg min-[600px]:text-2xl md:text-3xl xl:text-4xl'>Connect to <span className='text-black'>Sepolia Testnet</span></h2>
          <h2 className='font-lexend text-gray-500 text-lg min-[600px]:text-2xl md:text-3xl xl:text-4xl'>through <span className='text-black'>Metamask</span></h2>
      ...
      <About />
      <div id='boards' className='flex flex-col items-center justify-center gap-8 pt-10 xl:gap-16'>
        <div>
