  ...
  return (
      <div>
        ...
        <div className="flex flex-col justify-center items-center backdrop-blur-md min-h-screen gap-8">
          <h1 className='text-9xl text-center font-Pacifico text-white select-none max-sm:scale-90'>Talk Tuah</h1>
          <p className='text-lg text-center font-Bungee text-white select-none max-sm:scale-90'>Spit on that thang!</p>
